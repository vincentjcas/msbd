...
<div style="margin-bottom: 1.5rem;">
    <a href="{{ route('kepala_sekolah.kegiatan') }}" class="btn" style="background: #64748b; color: white; padding: 0.75rem 1.5rem; text-decoration: none; display: inline-flex; align-items: center; gap: 0.5rem; border-radius: 6px;">
...
<div class="welcome-card">
    ...
    <p>Perbarui informasi kegiatan sekolah</p>
</div>

<div class="content-section">
    <form action="{{ route('kepala_sekolah.kegiatan.update', $kegiatan->id_kegiatan) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div style="max-width: 800px;">
            ...
            <div class="form-row">
                <div class="form-group" style="flex: 1;">
                    ...
                    <input type="date" id="tanggal" name="tanggal" class="form-control" required value="{{ old('tanggal', $kegiatan->tanggal_mulai?->format('Y-m-d')) }}">
                    @error('tanggal')
                    <small style="color: #ef4444;">{{ $message }}</small>
                    @enderror
                </div>
                ...
                <div class="form-group" style="flex: 1;">
                    ...
                    <input type="time" id="waktu_mulai" name="waktu_mulai" class="form-control" required value="{{ old('waktu_mulai', $kegiatan->waktu_mulai) }}">
                    @error('waktu_mulai')
                    <small style="color: #ef4444;">{{ $message }}</small>
                    @enderror
                </div>
                ...
                <div class="form-group" style="flex: 1;">
                    ...
                    <input type="time" id="waktu_selesai" name="waktu_selesai" class="form-control" required value="{{ old('waktu_selesai', $kegiatan->waktu_selesai) }}">
                    @error('waktu_selesai')
                    <small style="color: #ef4444;">{{ $message }}</small>
                    @enderror
                </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="lokasi" name="lokasi" class="form-control" value="{{ old('lokasi', $kegiatan->tempat) }}" placeholder="Contoh: Ruang Guru">
                @error('lokasi')
                <small style="color: #ef4444;">{{ $message }}</small>
                @enderror
            </div>
            ...
            <div style="display: flex; gap: 1rem; margin-top: 2rem;">
                ...
                <a href="{{ route('kepala_sekolah.kegiatan') }}" class="btn" style="background: #6b7280; color: white;">
